export class ProjectsService {
  projects = [
    { name: 'USF - My Compass', caption: 'Using the Angular CLI (Angular JS and Typescript), this tool was built for the local Sarasota/Manatee campus', image: '../../assets/usf.jpg', link:'https://gist.github.com/m1g/06cdc048da09f40536a9a7550beb3f05' },
